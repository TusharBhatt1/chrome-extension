	...
	return (
		<TabsPrimitive.Trigger
			className={cn(
				...
				"data-[state=active]:bg-background", // ✅ Light mode active
				"dark:data-[state=active]:bg-transparent", // ✅ Dark mode active bg
				"dark:data-[state=active]:border-red-100", // ✅ Test visibility
